...
if($da_code == "all")
	{
		$result = mysql_query("SELECT * FROM restaurant_table WHERE rt_table_active = '$active' ORDER BY rt_table_display ")or die( "An error has ocured: " .mysql_error (). ":" .	mysql_errno ());
	}
else
	{
	/////////////////////////////////////////////////////
