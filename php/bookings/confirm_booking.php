...
/////////////////////////////////////////////////////
/////////////////////////////////////////////////////
$result = mysql_query( "UPDATE reservations SET rm_reservation_status  = '$statusFlag' WHERE rm_reservation_code = '$rm_reservation_code' AND rm_reservation_date  = '$rm_reservation_date' ") or die( "An error has ocured statement 1: " .mysql_error (). ":" .mysql_errno ());
mysql_close($link)
?>
